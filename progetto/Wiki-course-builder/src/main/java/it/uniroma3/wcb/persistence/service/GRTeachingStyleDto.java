 ...
 *
 */
public class GRTeachingStyleDto {

	private double expert;
	private String expert_range;
	private double formalauthority;
	private String formalauthority_range;
	private double personalmodel;
	private String personalmodel_range;
	private double facilitator;
	private String facilitator_range;
	private double delegator;
	private String delegator_range;
	...
	public String getFormalauthority_range() {
		return formalauthority_range;
	}
	public void setFormalauthority_range(String formalauthority_range) {
		this.formalauthority_range = formalauthority_range;
	}
	...
	public String getPersonalmodel_range() {
		return personalmodel_range;
	}
	public void setPersonalmodel_range(String personalmodel_range) {
		this.personalmodel_range = personalmodel_range;
	}
	...
	public String getFacilitator_range() {
		return facilitator_range;
	}
	public void setFacilitator_range(String facilitator_range) {
		this.facilitator_range = facilitator_range;
	}
	...
	public String getDelegator_range() {
		return delegator_range;
	}
	public void setDelegator_range(String delegator_range) {
		this.delegator_range = delegator_range;
	}
